...
public class MobilePostProcessing : MonoBehaviour
{
    ...
    static readonly string              bloomKeyword = "BLOOM";             // 光晕
    static readonly string              blurKeyword = "BLUR";               // 模糊
    static readonly string              chromaKeyword = "CHROMA";           // 色度
    ...
    static readonly string              distortionKeyword = "DISTORTION";   // 扭曲
